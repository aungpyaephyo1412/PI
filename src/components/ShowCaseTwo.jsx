import IMg from '../assets/dd/dd44.png'
...
const ShowCaseTwo = () => {
    return(
        <section className='w-full h-auto md:h-[550px] container mx-auto py-9 px-3 showcase'>
            <div className="bg-url2 w-full h-full rounded-3xl">
                <div className="w-full flex flex-wrap h-full">
                    <div className="w-full md:w-[35%] flex flex-col justify-center items-center h-full">
                        <div className="w-full flex gap-x-3 justify-center items-center">
                            ...
                            <div>
                                <h1 className='text-white text-3xl font-bold'>Pods</h1>
                    ...
                    <div className="w-full md:w-[65%] h-full pl-5 md:pl-0 pb-9 pt-11 relative">
                        <div className='w-full h-full'>
                            ...
                            <button className='py-2 md:py-14 px-2 glass rounded text-white button-next-88 absolute right-3 top-[33%] md:top-[25%] z-30'>
                                <BiRightArrow/>
                            </button>
                        </div>
                    </div>
